...
![Pixlr_20191217155208460.jpg](../../images/archive/GPPL和内部DSL、外部DSL.jpg " ")
...
![嵌套函数在流程抽象的应用范例](../../images/archive/嵌套函数在流程抽象的应用范例.jpg "嵌套函数在流程抽象的应用范例")
...
![所列举的内部DSL构建风格对比简表](../../images/archive/所列举的内部DSL构建风格对比简表.jpg)
