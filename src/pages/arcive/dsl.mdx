...
![header](../../images/arcive/v2cb09d892ec78f48e58b918c0b8d4ca23_1200x500.jpg " ")
## 前言
...
![Pixlr_20191217155208460.jpg](../../images/arcive/GPPL和内部DSL、外部DSL.jpg " ")
...
![嵌套函数在流程抽象的应用范例](../../images/arcive/嵌套函数在流程抽象的应用范例.jpg "嵌套函数在流程抽象的应用范例")
...
![所列举的内部DSL构建风格对比简表](../../images/arcive/所列举的内部DSL构建风格对比简表.jpg)
