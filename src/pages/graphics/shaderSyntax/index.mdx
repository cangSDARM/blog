...
[固定函数着色器语法(Fixed Function shader)](./shader1.0)

[顶点/片元着色器(CG)语法(Vertex/Fragment shader)](./shader2.0)

[表面着色器语法(Surface shader)](./shader3.0)

[shaderLab与CG的联系与区别](./shaderLab&CG)